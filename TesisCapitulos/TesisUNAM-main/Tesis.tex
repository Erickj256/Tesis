...
\modalidad{T E S I S}
\tituloprofesional{Licenciado en Matemáticas}
\facultad{Facultad de Ciencias}
\escudofacultad{EscudoFCiencias}
\supervisor{Dr. Verónica Esther Arriola Ríos}
...
\input{./Capitulos/introduccion} % Introduction

\input{./Capitulos/Capitulo1} % Modelos compartimentales y modelo SIR
