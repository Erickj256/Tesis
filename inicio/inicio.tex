...
\begin{document}
	...
	\begin{figure}[htb]
	\centering
	\includegraphics[width=0.5\textwidth]{imagenes/beta15.png}
	\caption{Gráfico de las soluciones de $S \left(t\right)$, $I\left(t			\right)$ y $R \left(t\right)$, tomando como parámetros $\beta = 1.5$,
	$\gamma = 0.2$ y las condiciones iniciales $S_{0} = 999999$ ,
	$I_{0} = 1$ y $R_{0} = 0$}	
	\end{figure}
	...
	\begin{figure}[htb]
	\centering
	\includegraphics[width=0.5\textwidth]{imagenes/beta05.png}
	\caption{Gráfico de las soluciones de $S \left(t\right)$, $I\left(t			\right)$ y $R \left(t\right)$, tomando como parámetros $\beta = 0.5$,
	$\gamma = 0.2$ y las condiciones iniciales $S_{0} = 999999$ ,
	$I_{0} = 1$ y $R_{0} = 0$}
	\end{figure}
